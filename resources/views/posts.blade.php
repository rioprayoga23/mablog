    ...
    @if ($posts->count())
            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted">
                        <a href="/posts?user={{ $posts[0]->user->username }}" class="text-decoration-none">By :
                            {{ $posts[0]->user->username }}</a> in
        ...
        <div class="container">
            <div class="row">
                ...
                {{-- melakukan pengambilan data dengan meng-skip data pertama --}}
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>
                                    <small class="text-muted">
                                        <a href="/posts?user={{ $post->user->username }}" class="text-decoration-none">By
                                            :
